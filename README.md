...
**Learn. Break. Investigate. Document.**
...
[![Offensive Security](https://img.shields.io/badge/Offensive_Security-red?style=for-the-badge&logo=kalilinux&logoColor=white)](#)
[![Defensive Security](https://img.shields.io/badge/Defensive_Security-blue?style=for-the-badge&logo=shield&logoColor=white)](#)
[![CTFs & Labs](https://img.shields.io/badge/CTFs_%26_Labs-green?style=for-the-badge&logo=terminal&logoColor=white)](#)
...
> **Note:** If a write-up appears incomplete or has missing sections, please refer to the corresponding original HTML copy in `html version`.
...
**Explore the work. Follow the process. Learn from the results.**
